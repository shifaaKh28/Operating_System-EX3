#include "kosaraju_proactor.hpp" // Include the header file for function declarations and global variables
...
int main() {
    ...
    while (true) {
        ...
        if (newfd == -1) {
            ...
            proactor.startProactor(newfd, handleClient); // Use the proactor to handle the client connection
        }
    }
